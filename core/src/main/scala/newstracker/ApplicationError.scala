...
sealed trait ApplicationError extends NoStackTrace { // NoStackTrace nice optimization stuff when you don't need stacktrace,
  // because you apriori know where error was thrown
  def message: String
  override def getMessage: String = message
}

object ApplicationError { // I am not sure that it's better to have impls throughout the project
